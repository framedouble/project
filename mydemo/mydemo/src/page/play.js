...
import './play.css'
import $ from "jquery";
import { playUrl, getLyric, songDetail } from "../utils/index";
import Img from '../assest/images/needle-ip6.png'
      ...
      return (
        <div className="play">
          ...
          <div className="audio_box">
            <audio ref={this.audio} src={songUrl} controls  autoPlay></audio>
          </div>
        </div>
      );
    }
